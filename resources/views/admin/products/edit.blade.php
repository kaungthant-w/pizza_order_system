                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-7 ">
                                <span class="my-3 btn btn-danger d-block col-12 fs-5"> <i class="fa-solid fa-user-pen mr-2"></i>  {{$pizza->name}} </span>

                                <span class="my-3 btn btn-dark"><i class="fa-solid fs-5 fa-money-bill-1-wave mr-2"></i> {{$pizza->price}} kyats</span>
                                <span class="my-3 btn btn-dark"><i class="fa-solid fs-5 fa-clock mr-2"></i> {{$pizza->waiting_time}} </span>
                                <span class="my-3 fs-5 btn btn-dark"><i class="fa-solid fa-eye mr-2"></i> {{$pizza->view_count}} </span>
                                <span class="my-3 fs-5 btn btn-dark"><i class="fa-solid fa-clone mr-2"></i> {{$pizza->category_name}} </span>
